<?php
$product = Requests::post($api_endpoint . "product/supplier", $header);
...
<div class="box-account box-info">
    ...
    <div class="row review-block mt-4">
        <?php
            foreach ($product_data as $pad) {

                //melihat apakah produk sudah live atau sedang direview
                if ($pad['status'] == 0) {
                    $show = '<span class="badge badge-secondary float-right">In Review</span>';
                } else {
                    $show = '<span class="badge badge-success float-right">Live</span>';
                }
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
            <div class="card" style="border-radius: 25px;">
                ...
                <div class="card-body" style="margin-top: -25px;">
                    ...
                    <a href="#" data-href="?product&supplier&action=delete&target=<?= $pad['id'] ?>" data-toggle="modal"
